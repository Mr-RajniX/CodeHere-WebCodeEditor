...
const EditProject = () => {
    ...
    const updateOutput = (html, css, js) => {
                ...
                {user && (
                    <div className="flex items-center justify-center gap-4">
                        <motion.button
                            onClick={saveProgram}
                            whileTap={{ scale: 0.9 }}
                            className="px-4 py-2 bg-green-600 cursor-pointer text-base text-white font-semibold rounded-md"
                        >
                            Save
                        </motion.button>
                        <UserProfileDetails />
                    ...
                    <SplitPane split="vertical" minSize={500}>
                        <div className="w-full h-full flex flex-col items-start justify-start">
                            <div className="w-full flex items-center justify-between">
                                ...
                                <div className="curser-pointer flex items-center justify-center gap-5 px-4">
                                    <Button
                                    ...
                                    >
                                        <ToastContainer
                                            ...
                                            autoClose={2000}
                                        />
                                        <FiCopy className="text-xl text-primaryText" />
                                    </Button>
                                </div>
                            </div>
