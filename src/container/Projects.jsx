...
const ProjectCard = ({ project, index }) => {
    ...
    return (
        <motion.div
            ...
            className="w-full cursor-pointer md:w-[390px] h-[320px] bg-slate-900 rounded-md p-4 flex flex-col items-center justify-center gap-4 transform transition-transform duration-300 hover:scale-110"
